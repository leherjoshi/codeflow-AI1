...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsAnalyzing(true)
      await login(formData.leetcode_username, formData.password)
      // Analysis happens in the login function
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black">
      ...
      {/* Login Form */}
      <div className="relative z-10 container mx-auto flex min-h-[calc(100vh-4rem)] items-center justify-center px-6">
        <motion.div
                ...
                >
                  {isAnalyzing ? (
                    <>
                      ...
                      Analyzing your LeetCode profile...
                    </>
                  ) : isLoading ? (
                    "Signing in..."
                  ) : (
